<template>
  ...
  >
    <h1
      class="
        text-center text-bookmark-white
        font-bold
        border-b
        mb-14
        mt-0
    ...
    <div
      class="
        flex
        md:justify-end md:right-0 md:top-0 md:mr-28
        mt-7
        gap-3
        justify-center
        mb-10
    ...
    <div class="p-4 justify-start md:bottom-0 inline-flex mb-1 flex-wrap md:flex-nowrap">
      <a
        href=" https://github.com/Fmwanikikenya?tab=repositories"
        target="_blank"
        rel="noopener noreferrer"
        class="p-3 mt-3 mx-2 mb-1"
        ><svg
      ...
      ><!-- linkedin -->
      <a
        href="https://www.facebook.com/profile.php?id=100073476542957"
        target="_blank"
        rel="noopener noreferrer"
        class="p-3 mt-3 mx-2 mb-1"
        ><svg
      ...
      ><!-- fb -->
      <a
        href="https://mobile.twitter.com/FRANCIS54691620"
        target="_blank"
        rel="noopener noreferrer"
        class="p-3 mt-3 mx-2 mb-1"
        ><svg
    ...
    <div
      ...
      "
    >
      <span>All Rights Reserved &copy; Copyright 2022 Franc_Pro</span>
    </div>
  </section>
</template>
