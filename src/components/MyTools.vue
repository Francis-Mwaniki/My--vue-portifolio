<template>
  <section class="flex bg-yellow-200 pb-20 md:mt-40">
    <div class="container items-center justify-center mt-2">
      <h1
        class="
          text-center
          font-bold
      ...
      <div class="md:inline-flex flex-row justify-between md:gap-16 lg:ml-52">
        <!-- vue -->
        <svg
